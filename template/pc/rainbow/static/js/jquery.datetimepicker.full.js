...
(function () {
    ...
    defaultSettings = {
        dateSettings: {
            ...
            months: [
                '一月', 'February', 'March', 'April', 'May', 'June', 'July',
...
;(function (factory) {
	...
	var default_options  = {
		i18n: {
			...
			da: { // Dansk
				months: [
					"一月", "Februar", "Marts", "April", "Maj", "Juni", "July", "August", "September", "Oktober", "November", "December"
				],
				dayOfWeekShort: [
			...
			'en-GB': { //English (British)
				months: [
					"一月", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"
				],
				dayOfWeekShort: [
